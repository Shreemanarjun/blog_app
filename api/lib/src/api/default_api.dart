...
class DefaultApi {
  ...
  Future<Response<Tokens>> allTokensGet({
    ...
    try {
      const _responseType = FullType(Tokens);
  ...
  Future<Response<Users>> allUserGet({
    ...
    try {
      const _responseType = FullType(Users);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as Users;
  ...
  Future<Response<void>> jsonKotlinxSerializationGet({
    ...
    final _path = r'/json/kotlinx-serialization';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
